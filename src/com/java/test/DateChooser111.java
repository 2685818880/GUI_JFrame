...
public class DateChooser111 extends JPanel
{
   public static void main(String[] args) {
	   JFrame frame=new JFrame("dee");
	   JPanel cp=new JPanel();
	   DateChooser111 dc=new DateChooser111 (cp);
	   cp.add(dc);
	   ...
	   frame.setVisible(true);
        ...
        public DateChooser111(Container owner,int length) {
           this.owner = owner;
        ...
        public DateChooser111(Container owner, String partten,int length) {
            this.owner = owner;
            this.parten = partten;
            this.length=length;
            try {
        ...
        public DateChooser111(Container owner, String partten) {
            this.owner = owner;
            this.parten = partten;
            try {
                init();
        ...
        public DateChooser111(Container owner) {
            this.owner = owner;
            this.parten = "yyyy-MM-dd";
            try {
                init();
        ...
        private void init() throws Exception {
            ...
            btnChoose.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    DateChooser111.this.btnChoose_actionPerformed(e);
                }
            });
            Date date = new Date();
    ...
    //控制条配色------------------//
            ...
            private Date getSelectDate() {
            	System.out.println(calendar.getTime()+"day");
    ...
    //            c.set
            ...
            private int getSelectedYear() {
            	System.out.println( ((Integer) yearSpin.getValue()).intValue()+"year");
                return ( (Integer) yearSpin.getValue()).intValue();
            }
   
            private int getSelectedMonth() {
            	System.out.println( ( (Integer) monthSpin.getValue()).intValue()+"month");
                return ( (Integer) monthSpin.getValue()).intValue();
            }
   
            private int getSelectedHour() {
            	System.out.println( ( (Integer) hourSpin.getValue()).intValue()+"hour");
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                    ...
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
                        pattern);
                    DateChooser111.this.setText(simpleDateFormat.format(selectDate));
